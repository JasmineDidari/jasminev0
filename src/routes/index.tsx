...
const blogs = [
  ...
  },
  {
    ...
    slug: "nis2",
    excerpt: "Skärpta krav på cybersäkerhet — vad NIS2 betyder för din leverantörskedja.",
  ...
  },
  {
    ...
    slug: "chatgpt-china",
    excerpt: "OpenAI:s nya datacenterplaner väcker frågor om var dina prompts faktiskt landar.",
  ...
  return (
    <div className="min-h-screen bg-home-background text-home-foreground">
      ...
      <main className="relative z-10">
          ...
          <div className="container mx-auto flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] font-medium uppercase tracking-[0.35em] text-home-muted">
                  Vendor Sovereignty Index
                </div>
              </div>
            </div>
            <nav className="hidden gap-8 text-sm font-medium text-home-muted md:flex">
              <Link to="/how-it-works" className="hover:text-home-foreground">
                Så fungerar det
              </Link>
              <Link to="/results" className="hover:text-home-foreground">
                Ranking
              </Link>
              <Link to="/certification-journey" className="hover:text-home-foreground">
                Om
              </Link>
            </nav>
        ...
        <section id="quiz" className="container mx-auto px-6 pb-20 pt-28 md:pb-28 md:pt-36">
          <motion.div
          ...
          >
            ...
            <p className="mx-auto mt-7 max-w-2xl text-balance text-lg leading-8 text-home-muted md:text-xl">
              Bredbandskollen — fast för leverantörer. Få på 60 sekunder en kompatibilitetspoäng som
              visar hur väl era leverantörer följer EU-suveränitet, GDPR, NIS2 och DORA.
            </p>
          ...
          <div className="mx-auto mt-20 grid max-w-5xl overflow-hidden rounded-2xl border border-home-border bg-home-surface/80 md:grid-cols-3">
            {features.map((f, i) => (
              ...
              >
                ...
                <p className="mt-5 text-xs font-medium uppercase tracking-[0.24em] text-home-muted">
                  {f.kicker}
                </p>
        ...
        <section id="how" className="border-y border-home-border bg-home-background/80 px-6 py-20">
          <div className="container mx-auto max-w-5xl text-center">
            <p className="text-xs font-black uppercase tracking-[0.5em] text-home-signal">
              Process
            </p>
            ...
            <div className="mt-12 grid gap-4 text-left md:grid-cols-3">
              {processSteps.map((item) => (
                <article
                  key={item.step}
                  className="rounded-2xl border border-home-border bg-home-surface p-6"
                >
                  <p className="text-xs font-bold uppercase tracking-[0.25em] text-home-signal">
                    {item.step}
                  </p>
